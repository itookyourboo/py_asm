...
Вся машина реализована в модуле `core.machine`. Компьютер состоит из следующих частей:
...
Также основан на генераторах. Работа с I/O происходит посимвольно, то есть считать и напечатать можно только один символ.

Для упрощения работы также были добавлены функции по чтению и печати чисел.
...
|----------------|-------|-----|-----------|-------------|--------|-------|
| Харламов А.С.  | cat   | 25  | 1250      | 15          | 56     | 68    |
|                | hello | 14  | 701       | 7           | 69     | 80    |
|                | prob5 | 43  | 1852      | 27          | 1468   | 2313  |
